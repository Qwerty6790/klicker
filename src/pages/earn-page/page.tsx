...
export default function EarnPage() {
  ...
  return (
    ...
    <div className="container">
      ...
      <div className="Cards">
        <MiningCard title={'Студия'} level={1} profit={500} price={100}/>
        <MiningCard title={'Маркет'} level={1} profit={500} price={100}/>
        <MiningCard title={'Семпл'} level={1} profit={500} price={100}/>
        <MiningCard title={'статуя'} level={1} profit={500} price={100}/>
        <MiningCard title={'автосалон'} level={1} profit={500} price={100}/>
        <MiningCard title={'автосалон'} level={1} profit={500} price={100}/>
      </div>
        </div>
    </section>
